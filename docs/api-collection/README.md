...
**Erro:** login com senha inválida (422), criar consulta sem token (401), listar com token inválido (401), buscar consulta inexistente (404), notificações sem token (401), GraphQL sem token (401).
